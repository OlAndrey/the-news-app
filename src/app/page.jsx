...
const data = new Array(6).fill(0).map((val, i) => {
  return {
    ...
    title: 'New Lions safety Jayron Kearse suspended three games. New Lions safety Jayron Kearse suspended three games. New Lions safety Jayron Kearse suspended three games',
    description:
